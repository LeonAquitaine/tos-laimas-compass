                    ...
                    fs.readFile(path, 'utf8', function (err, data) {
                        ...
                        for (var i = 0; i < queue.length; i++) {
                            ...
                            if (dat.length > 3) {
                                ...
                                if (data.length > 8) {// Extra data: Event coordinates
                                    event.X = Number(dat[8]);
                                    event.Y = Number(dat[9]);
                                }
                                ...
                                if (event.Type == "KILL") {
                                    ...
                                    // save mob kills for heatmap
                                    if (event.X)
                                        global.app.modules.data.saveMobKillData(event.Mob, event.Character + ' ' + event.Family, event.Map, event.X, event.Y);
                                }
